...
public class Exercisi10_4 {
    ...
    public static void main (String[]args){
        ...
        int valorUsuari = 0, senars = 0, sortida = -1, repeticio = 0;
        boolean valorNOk = true;
        
        //Solicitem el nombre per primera vegada
        do{
        ...
        while (valorNOk=false && INTENTS < 3);
        ...
        repeticio++;
    while (repeticio < 2 && valorUsuari!=-1);
    } 
